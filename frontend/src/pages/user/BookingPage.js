...
const BookingPage = () => {
    ...
    const fetchAvailableSlots = async () => {
      ...
      try {
        const res = await fetch(
          `https://api.getfitindia.in/api/slots/${venueId}/${selectedCourt._id}/available?date=${selectedDate}`
        );
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      ...
      try {
        const res = await fetch(
          `https://api.getfitindia.in/api/slots/${venueId}/${selectedCourt._id}/bookings?date=${selectedDate}`
        );
        if (!res.ok) {
  ...
  useEffect(() => {
    const fetchBlocked = async () => {
      ...
      try {
        const res = await fetch(
          `https://api.getfitindia.in/api/block/${venueId}/${selectedCourt._id}?date=${selectedDate}`
        );
        const data = await res.json();
